...
For probabilistic evaluation, as many masks as desired temporal subsets
can be provided.
...
For deterministic evaluation, the number of temporal subsets must necessarily
either be one, or the number of time series of observations, or the number
of time series of predictions.