...
.. function:: evald(q_obs, q_prd, metrics, q_thr=NULL, events=NULL, transform=NULL, exponent=NULL, epsilon=NULL, t_msk=NULL, bootstrap=NULL, dts=NULL, seed=NULL, diagnostics=NULL)
